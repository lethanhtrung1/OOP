...
class Student60 {
    ...
    public Student60(int i, String name, String s, double p1, double p2) {
...
public class J05060_KetQuaXetTuyen {
    public static void main(String[] args) {
        ...
        ArrayList<Student60> arr = new ArrayList<>();
        int n = in.nextInt();
        for(int i = 1; i <= n; i++) {
            in.nextLine();
            arr.add(new Student60(i, in.nextLine(), in.next(), in.nextDouble(), in.nextDouble()));
        }
        for(Student60 it : arr) {
